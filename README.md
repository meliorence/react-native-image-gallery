...
This component aims to be (one of) the best image viewers for React Native apps. Comparing with other gallery alike components, this one should be more elegant in following aspects: (mimics iOS system photo album app).

* Gesture handle: besides common pan, pinch and doubleTap, this component does well in targeting focus point (also known as pivot) on zoom-in and zoom-out.
